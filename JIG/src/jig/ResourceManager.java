...
public class ResourceManager {
	...
	public static Sound getSound(final String rscName) {
		if(sounds.get(rscName) == null) {
			System.err.println("Warning: Sound '"
					+ rscName + "' was requested that wasn't previously loaded. " +
					"Use loadSound(path) before calling getSound(path) to avoid runtime lag.");
			loadSound(rscName);
		}
