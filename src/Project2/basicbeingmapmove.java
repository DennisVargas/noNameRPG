...
// */
//public class basicbeingmapmove extends Entity{
//
//
//    private float health = 1f;
//
//    /**
//     * All of the possible animations that a being can have at the moment.
//     * todo:Attack animations for melee character will need to be similar to walk.
//     */
...
//    boolean isHit = false;
//
//    public basicbeingmapmove(Vector position, SpriteSheet walkingSheet, SpriteSheet attackingSheet) {
//        super(position);
...
//        CalculateCurrentDisplacement();
//    }
//
//    public void setCurrentDisplacementX(int x){
//        this.currentDisplacement= new Vector((float)x,
//                this.currentDisplacement.getY());
//    }
//    public void setCurrentDisplacementY(int y){
//        this.currentDisplacement=
//                new Vector(this.currentDisplacement.getX(),(float)y);
//    }
...
//        return this.nextMoveTranslation;
//    }
//}
